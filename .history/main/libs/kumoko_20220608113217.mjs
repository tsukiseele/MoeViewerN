...
export default class Kumoko {
  ...
  /**
   * 根据站点解析数据，返回结果集
   * @param {Boolean} isParseChildren 如果为true，则同时递归解析子节点树，否则只解析基本信息
   ...
   * @returns {Promise<Array<Object>>} 结果集
   */
  ...
  async requestText(url, options) {
    ...
    throw Error('request failed: ' + url)
  }
